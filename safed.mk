...
NONFREE_COMMIT ?= 28bc83e510a880a56cbd9e45b9a19fd6fa5675e1
...
$(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache_reg_pkg.sv $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache_reg_top.sv: $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_regs_icache.hjson
	$(REGGEN) $< -t $(SAFED_HW_DIR)/soc_ctrl -r
	cd $(SAFED_ROOT) && git apply $(SAFED_HW_DIR)/soc_ctrl/boot_addr_icache.patch
	$(REGGEN) $< -d >> $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache.md
	$(REGGEN) $< -D > $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache.h
...
safed-hw-gen: $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache_reg_pkg.sv $(SAFED_HW_DIR)/soc_ctrl/safety_soc_ctrl_icache_reg_top.sv
